...
public class BlockFlowerOfDreams extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:flowerofdreams")
	public static final Block block = null;
	public BlockFlowerOfDreams(ElementsColesRandomnessMod instance) {
		super(instance, 89);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("coles_randomness:flowerofdreams", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("flowerofdreams");
			setRegistryName("flowerofdreams");
		}
