...
public class BlockGodSlab extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:god_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("coles_randomness:god_slab_double")
	public static final Block block_slab_double = null;
	public BlockGodSlab(ElementsColesRandomnessMod instance) {
		super(instance, 458);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("god_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("god_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("coles_randomness:god_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("god_slab");
