...
import net.mcreator.coles_randomness.world.WorldGodsDimension;
import net.mcreator.coles_randomness.world.WorldDiamondDimension;
import net.mcreator.coles_randomness.ElementsColesRandomnessMod;

import java.util.Random;

@ElementsColesRandomnessMod.ModElement.Tag
public class BlockGodMushroom extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:god_mushroom")
	public static final Block block = null;
	public BlockGodMushroom(ElementsColesRandomnessMod instance) {
		super(instance, 356);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("coles_randomness:god_mushroom", "inventory"));
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		if (dimID == WorldGodsDimension.DIMID)
			dimensionCriteria = true;
		if (dimID == WorldDiamondDimension.DIMID)
			dimensionCriteria = true;
