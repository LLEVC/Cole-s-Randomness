...
public class BlockDemonSlab extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:demon_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("coles_randomness:demon_slab_double")
	public static final Block block_slab_double = null;
	public BlockDemonSlab(ElementsColesRandomnessMod instance) {
		super(instance, 474);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("demon_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("demon_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("coles_randomness:demon_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("demon_slab");
