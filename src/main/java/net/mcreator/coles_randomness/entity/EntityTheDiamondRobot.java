...
public class EntityTheDiamondRobot extends ElementsColesRandomnessMod.ModElement {
	...
	public EntityTheDiamondRobot(ElementsColesRandomnessMod instance) {
		super(instance, 28);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("coles_randomness", "thediamondrobot"), ENTITYID)
						.name("thediamondrobot").tracker(64, 3, true).egg(-16776961, -13369345).build());
	}
