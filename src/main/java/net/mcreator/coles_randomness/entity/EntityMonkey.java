...
public class EntityMonkey extends ElementsColesRandomnessMod.ModElement {
	public static final int ENTITYID = 45;
	public static final int ENTITYID_RANGED = 46;
	public EntityMonkey(ElementsColesRandomnessMod instance) {
		super(instance, 425);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("coles_randomness", "monkey"), ENTITYID).name("monkey").tracker(64, 3, true).egg(-1, -1).build());
	}
	...
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(9, new EntityAIWander(this, 0.8));
		}
