...
public class EntityEmmicourtClone extends ElementsColesRandomnessMod.ModElement {
	public static final int ENTITYID = 15;
	public static final int ENTITYID_RANGED = 16;
	public EntityEmmicourtClone(ElementsColesRandomnessMod instance) {
		super(instance, 67);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("coles_randomness", "emmicourtclone"), ENTITYID)
						.name("emmicourtclone").tracker(64, 3, true).egg(-16776961, -10040065).build());
	}
