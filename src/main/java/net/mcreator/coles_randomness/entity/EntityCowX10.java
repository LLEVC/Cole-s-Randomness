...
import net.mcreator.coles_randomness.procedure.ProcedureCowX10ItIsStruckByLightning;
...
public class EntityCowX10 extends ElementsColesRandomnessMod.ModElement {
	public static final int ENTITYID = 27;
	public static final int ENTITYID_RANGED = 28;
	public EntityCowX10(ElementsColesRandomnessMod instance) {
		super(instance, 279);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("coles_randomness", "cowx10"), ENTITYID)
						.name("cowx10").tracker(64, 3, true).egg(-10079488, -10066330).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("plains")),
				...
				Biome.REGISTRY.getObject(new ResourceLocation("river")), Biome.REGISTRY.getObject(new ResourceLocation("void")),};
		EntityRegistry.addSpawn(EntityCustom.class, 20, 2, 10, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelCow(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("coles_randomness:textures/cow.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemCowSpawn.block, (int) (1)).getItem();
		}
