...
public class EntityRedstoneMaster extends ElementsColesRandomnessMod.ModElement {
	...
	public EntityRedstoneMaster(ElementsColesRandomnessMod instance) {
		super(instance, 30);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("coles_randomness", "redstonemaster"), ENTITYID)
						.name("redstonemaster").tracker(64, 3, true).egg(-65536, -16776961).build());
	}
