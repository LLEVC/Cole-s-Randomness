...
public class EntityGUNARMYTHINGYIDK extends ElementsColesRandomnessMod.ModElement {
	public static final int ENTITYID = 20;
	public static final int ENTITYID_RANGED = 21;
	public EntityGUNARMYTHINGYIDK(ElementsColesRandomnessMod instance) {
		super(instance, 88);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("coles_randomness", "gunarmythingyidk"), ENTITYID).name("gunarmythingyidk").tracker(64, 3, true).egg(-1, -1)
				.build());
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("coles_randomness", "entitybulletgunarmythingyidk"), ENTITYID_RANGED).name("entitybulletgunarmythingyidk")
	...
	public static class EntityCustom extends EntityMob implements IRangedAttackMob {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			enablePersistence();
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(ItemKolbesGun.block, (int) (1)));
		}
		...
		protected Item getDropItem() {
			return new ItemStack(ItemKolbesGun.block, (int) (1)).getItem();
		}
