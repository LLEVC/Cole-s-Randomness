...
import net.mcreator.coles_randomness.procedure.ProcedureEmmCloneModelToolInHandTick;
...
public class ItemEmmCloneModel extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:emm_clone_model")
	public static final Item block = null;
	public ItemEmmCloneModel(ElementsColesRandomnessMod instance) {
		super(instance, 346);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:emm_clone_model", "inventory"));
	}
