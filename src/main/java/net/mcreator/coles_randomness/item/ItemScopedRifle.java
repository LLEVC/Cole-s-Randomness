...
public class ItemScopedRifle extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:scoped_rifle")
	public static final Item block = null;
	public static final int ENTITYID = 52;
	public ItemScopedRifle(ElementsColesRandomnessMod instance) {
		super(instance, 600);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("coles_randomness", "entitybulletscoped_rifle"), ENTITYID).name("entitybulletscoped_rifle")
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:scoped_rifle", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(1000);
			setFull3D();
			setUnlocalizedName("scoped_rifle");
			setRegistryName("scoped_rifle");
			maxStackSize = 1;
