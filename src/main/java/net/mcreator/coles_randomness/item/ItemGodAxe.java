...
public class ItemGodAxe extends ElementsColesRandomnessMod.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("god_axe").setRegistryName("god_axe").setCreativeTab(CreativeTabs.TOOLS));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:god_axe", "inventory"));
	}
