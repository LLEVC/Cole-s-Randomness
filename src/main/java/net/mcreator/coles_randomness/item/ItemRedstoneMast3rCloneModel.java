...
import net.mcreator.coles_randomness.procedure.ProcedureRedstoneMast3rCloneModelToolInHandTick;
...
public class ItemRedstoneMast3rCloneModel extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:redstone_mast_3r_clone_model")
	public static final Item block = null;
	public ItemRedstoneMast3rCloneModel(ElementsColesRandomnessMod instance) {
		super(instance, 343);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:redstone_mast_3r_clone_model", "inventory"));
	}
