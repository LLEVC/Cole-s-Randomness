...
public class ItemRocketJumper extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:rocketjumper")
	public static final Item block = null;
	public ItemRocketJumper(ElementsColesRandomnessMod instance) {
		super(instance, 87);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:rocketjumper", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("Right click in mid air");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRocketJumperRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureRocketJumperRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
