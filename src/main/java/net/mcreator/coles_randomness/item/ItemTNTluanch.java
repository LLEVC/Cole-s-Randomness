...
import net.mcreator.coles_randomness.procedure.ProcedureTNTluanchBulletHitsBlock;
...
public class ItemTNTluanch extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:tntluanch")
	public static final Item block = null;
	public static final int ENTITYID = 13;
	public ItemTNTluanch(ElementsColesRandomnessMod instance) {
		super(instance, 39);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("coles_randomness", "entitybullettntluanch"), ENTITYID).name("entitybullettntluanch").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:tntluanch", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(100);
			setFull3D();
			setUnlocalizedName("tntluanch");
			setRegistryName("tntluanch");
			maxStackSize = 1;
				...
				if (entity.capabilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0
					...
					world.playSound((EntityPlayer) null, (double) x, (double) y, (double) z,
							(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
									.getObject(new ResourceLocation(("block.note.pling"))),
			...
			if (this.inGround) {
				{
					...
					ProcedureTNTluanchBulletHitsBlock.executeProcedure($_dependencies);
				}
