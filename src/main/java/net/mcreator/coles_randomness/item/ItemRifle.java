...
public class ItemRifle extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:rifle")
	public static final Item block = null;
	public static final int ENTITYID = 25;
	public ItemRifle(ElementsColesRandomnessMod instance) {
		super(instance, 272);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("coles_randomness", "entitybulletrifle"), ENTITYID).name("entitybulletrifle").tracker(64, 1, true).build());
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:rifle", "inventory"));
	}
