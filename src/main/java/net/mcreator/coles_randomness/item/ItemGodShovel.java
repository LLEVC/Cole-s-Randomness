...
public class ItemGodShovel extends ElementsColesRandomnessMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:god_shovel", "inventory"));
	}
}
