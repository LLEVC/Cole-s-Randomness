...
import net.mcreator.coles_randomness.procedure.ProcedureBlitzTDMCloneModelToolInHandTick;
...
public class ItemBlitzTDMCloneModel extends ElementsColesRandomnessMod.ModElement {
	@GameRegistry.ObjectHolder("coles_randomness:blitz_tdm_clone_model")
	public static final Item block = null;
	public ItemBlitzTDMCloneModel(ElementsColesRandomnessMod instance) {
		super(instance, 345);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("coles_randomness:blitz_tdm_clone_model", "inventory"));
	}
