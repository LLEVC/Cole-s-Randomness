...
public class WorldGodsDimension extends ElementsColesRandomnessMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("coles_randomness:godsdimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldGodsDimension(ElementsColesRandomnessMod instance) {
		super(instance, 277);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemGodsDimension().setUnlocalizedName("godsdimension").setRegistryName("godsdimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension godsdimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("godsdimension", "_godsdimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemGodsDimension.block, 0,
				new ModelResourceLocation("coles_randomness:godsdimension", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("godsdimension_portal");
			setRegistryName("godsdimension_portal");
			setLightLevel(0F);
		}
