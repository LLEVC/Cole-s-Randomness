...
package net.mcreator.coles_randomness.world;
...
import net.mcreator.coles_randomness.item.ItemDiamondDimension;
...
public class WorldDiamondDimension extends ElementsColesRandomnessMod.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("coles_randomness:diamond_dimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldDiamondDimension(ElementsColesRandomnessMod instance) {
		super(instance, 323);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemDiamondDimension().setUnlocalizedName("diamond_dimension").setRegistryName("diamond_dimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension diamond_dimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("diamond_dimension", "_diamond_dimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemDiamondDimension.block, 0,
				new ModelResourceLocation("coles_randomness:diamond_dimension", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.DIAMOND_ORE.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("diamond_dimension_portal");
			setRegistryName("diamond_dimension_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.DIAMOND_ORE.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.DIAMOND_ORE.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.DIAMOND_ORE
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = Blocks.DIAMOND_ORE.getDefaultState();
		private static final IBlockState STONE2 = Blocks.DIAMOND_ORE.getDefaultState();
		private static final IBlockState FLUID = Blocks.DIAMOND_BLOCK.getDefaultState();
