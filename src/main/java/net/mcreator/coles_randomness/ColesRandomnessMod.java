 ...
 *
 *    Keep the ElementsColesRandomnessMod object in this class and all calls to this object
...
public class ColesRandomnessMod {
	...
	@Mod.Instance(MODID)
	public static ColesRandomnessMod instance;
	public ElementsColesRandomnessMod elements = new ElementsColesRandomnessMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsColesRandomnessMod.GuiHandler());
