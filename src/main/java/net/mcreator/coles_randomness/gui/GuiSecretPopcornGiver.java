...
import net.mcreator.coles_randomness.procedure.ProcedureGivePopcorn;
import net.mcreator.coles_randomness.procedure.ProcedureGiveDirt;
import net.mcreator.coles_randomness.procedure.ProcedureGiveBonemeal;
...
public class GuiSecretPopcornGiver extends ElementsColesRandomnessMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiSecretPopcornGiver(ElementsColesRandomnessMod instance) {
		super(instance, 293);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 62 + 8 + sj * 18, 17 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 62 + 8 + si * 18, 17 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("coles_randomness:textures/secretpopcorngiver.png");
		@Override
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGivePopcorn.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureGiveDirt.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureGiveBonemeal.executeProcedure($_dependencies);
			}
		}
	}
