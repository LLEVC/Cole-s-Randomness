...
import net.mcreator.coles_randomness.procedure.ProcedureVendingSoda;
import net.mcreator.coles_randomness.procedure.ProcedureVendingChips;
...
public class GuiVendingGUI extends ElementsColesRandomnessMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiVendingGUI(ElementsColesRandomnessMod instance) {
		super(instance, 332);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("coles_randomness:textures/vending_gui.png");
		@Override
		...
		if (buttonID == 0) {
			{
				...
				ProcedureVendingChips.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureVendingSoda.executeProcedure($_dependencies);
			}
		}
	}
