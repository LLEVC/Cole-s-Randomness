...
import net.mcreator.coles_randomness.procedure.ProcedureTradingFunction;
...
public class GuiLostSoul extends ElementsColesRandomnessMod.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiLostSoul(ElementsColesRandomnessMod instance) {
		super(instance, 603);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("coles_randomness:textures/lost_soul.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 23, this.guiTop + 7, 125, 20, "Nether Star --> Soul"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureTradingFunction.executeProcedure($_dependencies);
			}
		}
	}
