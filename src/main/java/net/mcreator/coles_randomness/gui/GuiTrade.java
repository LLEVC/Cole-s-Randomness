...
public class GuiTrade extends ElementsColesRandomnessMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiTrade(ElementsColesRandomnessMod instance) {
		super(instance, 278);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("coles_randomness:textures/trade.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 5, this.guiTop + 6, 60, 20, "1 LV = 1 "));
		}
